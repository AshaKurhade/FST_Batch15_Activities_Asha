...
public class Activity13_2a {
    ...
    public void writeExcel(String filePath) throws IOException {
        ...
        String[] row1 = {"1", "ash", "kur", "ashkur@example.com", "90889929158"};
	
        String[] row2 = {"2", "Aditi", "jad", "aditij@example.com", "89902184058"};
	
        String[] row3 = {"3", "meghna", "dhot", "meghnaD@example.com", "890008727830"};
